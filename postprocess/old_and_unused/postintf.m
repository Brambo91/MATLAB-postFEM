...
% [ prepend.interface* ] where prepend is a global variable. These files are
% sorted alphabetically and number 'iint' of this list is used.
...
eval(['!ls ' prestring 'interface* > tmp.postintf'])
...
if filename ~= -1
  ...
  eval(['!ls -1 ' prestring 'interface* | wc -l'])
